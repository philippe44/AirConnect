...
1. Pre-built binaries are in `AirConnect-X.Y.Z.zip`. It can be downloaded manually in a terminal by typing `wget https://raw.githubusercontent.com/philippe44/AirConnect/master/airconnect.zip`. Unzip the file an select the bianry that works for your system.
